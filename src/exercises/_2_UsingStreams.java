...
//	/* Sort the exam results from lowest to highest. */
	...
	public void testSort() throws Exception {
		...
		assertEquals(38.4, AlgorithmsUsingStreams.sortScores(results).get(0));
		assertEquals(40.7, AlgorithmsUsingStreams.sortScores(results).get(1));
		assertEquals(95.0, AlgorithmsUsingStreams.sortScores(results).get(13));
	}
